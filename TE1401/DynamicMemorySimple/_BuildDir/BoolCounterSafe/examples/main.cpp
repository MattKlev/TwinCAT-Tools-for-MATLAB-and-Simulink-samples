...
int main(int, char **)
{
  ...
  main_count_and_invert_booleans_safe();
...
void main_count_and_invert_booleans_safe()
{
  coder::array<boolean_T, 2U> boolArray;
  coder::array<boolean_T, 2U> inverseArray;
  double count;
  // Initialize function 'count_and_invert_booleans_safe' input arguments.
  // Initialize function input argument 'boolArray'.
  boolArray = argInit_1xUnbounded_boolean_T();
  // Call the entry-point 'count_and_invert_booleans_safe'.
  count_and_invert_booleans_safe(boolArray, argInit_real_T(), &count,
                                 inverseArray);
}
