...
int main(int, char **)
{
  ...
  main_count_and_invert_booleans();
...
void main_count_and_invert_booleans()
{
  coder::array<double, 2U> inverseArray;
  coder::array<boolean_T, 2U> boolArray;
  double count;
  // Initialize function 'count_and_invert_booleans' input arguments.
  // Initialize function input argument 'boolArray'.
  boolArray = argInit_UnboundedxUnbounded_boolean_T();
  // Initialize function input argument 'inverseArray'.
  inverseArray = argInit_UnboundedxUnbounded_real_T();
  // Call the entry-point 'count_and_invert_booleans'.
  count = count_and_invert_booleans(boolArray, inverseArray);
}
