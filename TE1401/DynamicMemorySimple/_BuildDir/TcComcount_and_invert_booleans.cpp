// ****************** TcComcount_and_invert_booleans.cpp *************************
...
#include "TcComcount_and_invert_booleans.h"
...
///////////////////////////////////////////////////////////////////////////////
// CTcComcount_and_invert_booleans specific globals
///////////////////////////////////////////////////////////////////////////////


///////////////////////////////////////////////////////////////////////////////
// CTcComcount_and_invert_booleans static members
///////////////////////////////////////////////////////////////////////////////
TcMatSim_ModuleGeneratorInfo CTcComcount_and_invert_booleans::m_ModuleGeneratorInfo = {{23,2,0,2409890},{2,8,21,0}};


///////////////////////////////////////////////////////////////////////////////
// CTcComcount_and_invert_booleans implementation
///////////////////////////////////////////////////////////////////////////////
BEGIN_INTERFACE_MAP(CTcComcount_and_invert_booleans)
INTERFACE_ENTRY_ITCOMOBJECT()
	...
	INTERFACE_ENTRY(IID_ITccount_and_invert_booleans,ITccount_and_invert_booleans)
END_INTERFACE_MAP()

IMPLEMENT_ITCWATCHSOURCE(CTcComcount_and_invert_booleans)

BEGIN_OBJDATAAREA_MAP(CTcComcount_and_invert_booleans)
	OBJDATAAREA_SPAN_PTR_SIZE_LOCK(0, 1, &(Outports.count), sizeof(Outports.count), 0, VarAccess(Access::Read))
END_OBJDATAAREA_MAP()

BEGIN_SETOBJPARA_MAP2(CTcComcount_and_invert_booleans,TcMatSim::GeneratedTcCom)
...
BEGIN_GETOBJPARA_MAP2(CTcComcount_and_invert_booleans,TcMatSim::GeneratedTcCom)
...
BEGIN_OBJPARAWATCH_MAP2(CTcComcount_and_invert_booleans)
...
IMPLEMENT_ITCADI(CTcComcount_and_invert_booleans)

IMPLEMENT_IPERSIST_LIB(CTcComcount_and_invert_booleans,VID_Tc3_BoolCounter,CID_COUNT_AND_INVERT_BOOLEANS)

IMPLEMENT_GETMODULEINFO(CTcComcount_and_invert_booleans,count_and_invert_booleans,CID_COUNT_AND_INVERT_BOOLEANS,VID_Tc3_BoolCounter)

BEGIN_OBJPARAASYNC_MAP2(CTcComcount_and_invert_booleans,TcMatSim::GeneratedTcCom)
...
HRESULT CTcComcount_and_invert_booleans::SetObjStateIP(ITComObjectServer* ipSrv, TComInitDataHdr* pInitData)
{
	HRESULT hr = S_OK;
...
HRESULT CTcComcount_and_invert_booleans::SetObjStatePS(TComInitDataHdr* pInitData)
{
	HRESULT hr = S_OK;
...
HRESULT CTcComcount_and_invert_booleans::SetObjStateSO()
{
	HRESULT hr = S_OK;
...
HRESULT CTcComcount_and_invert_booleans::SetObjStateOS()
{
	HRESULT hr = S_OK;
...
HRESULT CTcComcount_and_invert_booleans::SetObjStateSP()
{
	HRESULT hr = S_OK;
...
HRESULT CTcComcount_and_invert_booleans::SetObjStatePI()
{
	HRESULT hr = S_OK;
...
// Constructor
CTcComcount_and_invert_booleans::CTcComcount_and_invert_booleans() :
...
HRESULT TCOMAPI CTcComcount_and_invert_booleans::CycleUpdate(ITcTask* ipTask, ITcUnknown* ipCaller, ULONG_PTR context)
{
...
HRESULT TCOMAPI CTcComcount_and_invert_booleans::PostCyclicUpdate(ITcTask* ipTask, ITcUnknown* ipCaller, ULONG_PTR context)
{
...
HRESULT CTcComcount_and_invert_booleans::Update(ITcTask* ipTask, ULONG_PTR context)
{
	...
	if(SUCCEEDED(hr) && m_ContextInfo[context].Synchronized)
	{
		...
		TcTry
		{
			if (hr == S_OK)
			{
				Outports.count = ::count_and_invert_booleans(boolArray,inverseArray);
			}
...
HRESULT CTcComcount_and_invert_booleans::CheckAndAdaptCycleTimes()
{
	return S_OK;
...
HRESULT TCOMAPI CTcComcount_and_invert_booleans::count_and_invert_booleans(double& count)
{
	HRESULT hr = S_OK;
	auto fpCtrl = FpControl(FpCtrlSection::Update);
...
// ITccount_and_invert_booleans
HRESULT TCOMAPI CTcComcount_and_invert_booleans::put_boolArray(bool* data, LONG size1, LONG size2)
{
	HRESULT hr(S_OK);
...
// ITccount_and_invert_booleans
HRESULT TCOMAPI CTcComcount_and_invert_booleans::get_boolArray(bool* data, LONG& size1, LONG& size2)
{
	HRESULT hr(S_OK);
...
// ITccount_and_invert_booleans
HRESULT TCOMAPI CTcComcount_and_invert_booleans::put_inverseArray(double* data, LONG size1, LONG size2)
{
	HRESULT hr(S_OK);
...
// ITccount_and_invert_booleans
HRESULT TCOMAPI CTcComcount_and_invert_booleans::get_inverseArray(double* data, LONG& size1, LONG& size2)
{
	HRESULT hr(S_OK);
...
// ITccount_and_invert_booleans
HRESULT TCOMAPI CTcComcount_and_invert_booleans::get_inverseArray_(double* data, LONG& size1, LONG& size2)
{
	HRESULT hr(S_OK);
	hr = TcMatSim::DataConversion::FromCoderArray(inverseArray,data,size1,size2);
	return hr;
...
{
	return Create<CTcComcount_and_invert_booleans>(*pIid, pipItf);
}
