...
// *************************************************************
#ifndef _FbBoolCounterSafe__h_INCLUDED
#define _FbBoolCounterSafe__h_INCLUDED
...
public:
	...
	inline CLSID get_ClassID() {return CID_FB_BOOLCOUNTERSAFE;}
	...
	~CFbBoolCounterSafe();
	bool FB_Main();
	static void _FB_Main(ST_FB_BoolCounterSafe_FB_Main* ST_Param);
	bool FB_exit(bool bInCopyCode);
	static void _FB_exit(ST_FB_BoolCounterSafe_FB_exit* ST_Param);
	bool FB_init(bool bInitRetains, bool bInCopyCode);
	static void _FB_init(ST_FB_BoolCounterSafe_FB_init* ST_Param);
	...
	static void _put_boolArray(ST_FB_BoolCounterSafe_put_boolArray* ST_Param);
	HRESULT get_boolArray(bool* data, LONG& size1, LONG& size2);
	static void _get_boolArray(ST_FB_BoolCounterSafe_get_boolArray* ST_Param);
	HRESULT get_inverseArray(bool* data, LONG& size1, LONG& size2);
	static void _get_inverseArray(ST_FB_BoolCounterSafe_get_inverseArray* ST_Param);



	double maxOutputSize;
	double count;
	PVOID boolArray;
	PVOID inverseArray;
...
TYPESIZE_VALIDATION2(CFbBoolCounterSafe,496,512);


#endif // _FbBoolCounterSafe__h_INCLUDED
