...
int main(int, char **)
{
  ...
  main_count_and_invert_booleans_io();
...
void main_count_and_invert_booleans_io()
{
  coder::array<double, 2U> inverseArray;
  coder::array<boolean_T, 2U> boolArray;
  double count;
  // Initialize function 'count_and_invert_booleans_io' input arguments.
  ...
  // Call the entry-point 'count_and_invert_booleans_io'.
