...
// ****************** FbTcComcount_and_invert_booleans.h *************************
...
// *************************************************************
#ifndef _FbTcComcount_and_invert_booleans__h_INCLUDED
#define _FbTcComcount_and_invert_booleans__h_INCLUDED
...
class CFbTcComcount_and_invert_booleans :
...
public:
	...
	inline CLSID get_ClassID() {return CID_FB_COUNT_AND_INVERT_BOOLEANS_TCCOM_INITSTRUCT;}

	DECLARE_FUNC_MAP_FB()

	CFbTcComcount_and_invert_booleans();
	~CFbTcComcount_and_invert_booleans();
	bool FB_init(bool bInitRetains, bool bInCopyCode, ST_FB_count_and_invert_booleans_TcCOM_InitStruct& stInit);
	static void _FB_init(ST_FB_count_and_invert_booleans_TcCOM_InitStruct_FB_init* ST_Param);
	bool FB_afterinit();
	static void _FB_AfterInit(ST_FB_count_and_invert_booleans_TcCOM_InitStruct_FB_afterinit* ST_Param);
	bool Reinit(ST_FB_count_and_invert_booleans_TcCOM_InitStruct stReInit);
	static void _Reinit(ST_FB_count_and_invert_booleans_TcCOM_InitStruct_Reinit* ST_Param);
	bool FB_Main();
	static void _FB_Main(ST_FB_count_and_invert_booleans_TcCOM_InitStruct_FB_Main* ST_Param);
	bool FB_exit(bool bInCopyCode);
	static void _FB_exit(ST_FB_count_and_invert_booleans_TcCOM_InitStruct_FB_exit* ST_Param);
	...
	static void _put_boolArray(ST_FB_count_and_invert_booleans_TcCOM_InitStruct_put_boolArray* ST_Param);
	HRESULT get_boolArray(bool* data, LONG& size1, LONG& size2);
	static void _get_boolArray(ST_FB_count_and_invert_booleans_TcCOM_InitStruct_get_boolArray* ST_Param);
	HRESULT put_inverseArray(double* data, LONG size1, LONG size2);
	static void _put_inverseArray(ST_FB_count_and_invert_booleans_TcCOM_InitStruct_put_inverseArray* ST_Param);
	HRESULT get_inverseArray(double* data, LONG& size1, LONG& size2);
	static void _get_inverseArray(ST_FB_count_and_invert_booleans_TcCOM_InitStruct_get_inverseArray* ST_Param);
	HRESULT get_inverseArray_(double* data, LONG& size1, LONG& size2);
	static void _get_inverseArray_(ST_FB_count_and_invert_booleans_TcCOM_InitStruct_get_inverseArray_* ST_Param);
	...
	count_and_invert_booleans_Outports_T stOutports;
	ITccount_and_invert_booleans* _ipcount_and_invert_booleans;
	ST_FB_count_and_invert_booleans_TcCOM_InitStruct stInit;


};
TYPESIZE_VALIDATION2(CFbTcComcount_and_invert_booleans,528,552);

			
#endif // _FbTcComcount_and_invert_booleans__h_INCLUDED
