...
#include "TcComBoolCounterIO_v2.h"
...
///////////////////////////////////////////////////////////////////////////////
// CTcComBoolCounterIO_v2 specific globals
///////////////////////////////////////////////////////////////////////////////


///////////////////////////////////////////////////////////////////////////////
// CTcComBoolCounterIO_v2 static members
///////////////////////////////////////////////////////////////////////////////
TcMatSim_ModuleGeneratorInfo CTcComBoolCounterIO_v2::m_ModuleGeneratorInfo = {{23,2,0,2409890},{2,8,21,0}};


///////////////////////////////////////////////////////////////////////////////
// CTcComBoolCounterIO_v2 implementation
///////////////////////////////////////////////////////////////////////////////
BEGIN_INTERFACE_MAP(CTcComBoolCounterIO_v2)
INTERFACE_ENTRY_ITCOMOBJECT()
	...
	INTERFACE_ENTRY(IID_ITcBoolCounterIO_v2,ITcBoolCounterIO_v2)
END_INTERFACE_MAP()

IMPLEMENT_ITCWATCHSOURCE(CTcComBoolCounterIO_v2)

BEGIN_OBJDATAAREA_MAP(CTcComBoolCounterIO_v2)
	OBJDATAAREA_SPAN_PTR_SIZE_LOCK(0, 1, &(Outports.count), sizeof(Outports.count), 0, VarAccess(Access::Read))
END_OBJDATAAREA_MAP()

BEGIN_SETOBJPARA_MAP2(CTcComBoolCounterIO_v2,TcMatSim::GeneratedTcCom)
...
BEGIN_GETOBJPARA_MAP2(CTcComBoolCounterIO_v2,TcMatSim::GeneratedTcCom)
...
BEGIN_OBJPARAWATCH_MAP2(CTcComBoolCounterIO_v2)
...
IMPLEMENT_ITCADI(CTcComBoolCounterIO_v2)

IMPLEMENT_IPERSIST_LIB(CTcComBoolCounterIO_v2,VID_Tc3_BoolCounter,CID_BOOLCOUNTERIO_V2)

IMPLEMENT_GETMODULEINFO(CTcComBoolCounterIO_v2,BoolCounterIO_v2,CID_BOOLCOUNTERIO_V2,VID_Tc3_BoolCounter)

BEGIN_OBJPARAASYNC_MAP2(CTcComBoolCounterIO_v2,TcMatSim::GeneratedTcCom)
...
HRESULT CTcComBoolCounterIO_v2::SetObjStateIP(ITComObjectServer* ipSrv, TComInitDataHdr* pInitData)
{
	HRESULT hr = S_OK;
...
HRESULT CTcComBoolCounterIO_v2::SetObjStatePS(TComInitDataHdr* pInitData)
{
	HRESULT hr = S_OK;
...
HRESULT CTcComBoolCounterIO_v2::SetObjStateSO()
{
	HRESULT hr = S_OK;
...
HRESULT CTcComBoolCounterIO_v2::SetObjStateOS()
{
	HRESULT hr = S_OK;
...
HRESULT CTcComBoolCounterIO_v2::SetObjStateSP()
{
	HRESULT hr = S_OK;
...
HRESULT CTcComBoolCounterIO_v2::SetObjStatePI()
{
	HRESULT hr = S_OK;
...
// Constructor
CTcComBoolCounterIO_v2::CTcComBoolCounterIO_v2() :
...
HRESULT TCOMAPI CTcComBoolCounterIO_v2::CycleUpdate(ITcTask* ipTask, ITcUnknown* ipCaller, ULONG_PTR context)
{
...
HRESULT TCOMAPI CTcComBoolCounterIO_v2::PostCyclicUpdate(ITcTask* ipTask, ITcUnknown* ipCaller, ULONG_PTR context)
{
...
HRESULT CTcComBoolCounterIO_v2::Update(ITcTask* ipTask, ULONG_PTR context)
{
	...
	if(SUCCEEDED(hr) && m_ContextInfo[context].Synchronized)
	{
		...
		TcTry
		{
			if (hr == S_OK)
			{
				Outports.count = ::count_and_invert_booleans_io_v2(boolArray,inverseArray);
			}
...
HRESULT CTcComBoolCounterIO_v2::CheckAndAdaptCycleTimes()
{
	return S_OK;
...
// ITcBoolCounterIO_v2
HRESULT TCOMAPI CTcComBoolCounterIO_v2::count_and_invert_booleans_io_v2(double& count)
{
	HRESULT hr = S_OK;
	auto fpCtrl = FpControl(FpCtrlSection::Update);
...
// ITcBoolCounterIO_v2
HRESULT TCOMAPI CTcComBoolCounterIO_v2::put_boolArray(bool* data, LONG size1, LONG size2)
{
	HRESULT hr(S_OK);
...
// ITcBoolCounterIO_v2
HRESULT TCOMAPI CTcComBoolCounterIO_v2::get_boolArray(bool* data, LONG& size1, LONG& size2)
{
	HRESULT hr(S_OK);
...
// ITcBoolCounterIO_v2
HRESULT TCOMAPI CTcComBoolCounterIO_v2::put_inverseArray(double* data, LONG size1, LONG size2)
{
	HRESULT hr(S_OK);
...
// ITcBoolCounterIO_v2
HRESULT TCOMAPI CTcComBoolCounterIO_v2::get_inverseArray(double* data, LONG& size1, LONG& size2)
{
	HRESULT hr(S_OK);
...
// ITcBoolCounterIO_v2
HRESULT TCOMAPI CTcComBoolCounterIO_v2::get_inverseArray_(double* data, LONG& size1, LONG& size2)
{
	HRESULT hr(S_OK);
	hr = TcMatSim::DataConversion::FromCoderArray(inverseArray,data,size1,size2);
	return hr;
...
HRESULT TCOMAPI Create_CTcComBoolCounterIO_v2 (PITCID pIid, PPVOID pipItf)
{
	return Create<CTcComBoolCounterIO_v2>(*pIid, pipItf);
}
