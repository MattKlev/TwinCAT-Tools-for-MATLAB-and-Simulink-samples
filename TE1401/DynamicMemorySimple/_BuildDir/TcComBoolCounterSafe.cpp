...
#include "TcComBoolCounterSafe.h"
...
///////////////////////////////////////////////////////////////////////////////
// CTcComBoolCounterSafe specific globals
///////////////////////////////////////////////////////////////////////////////


///////////////////////////////////////////////////////////////////////////////
// CTcComBoolCounterSafe static members
///////////////////////////////////////////////////////////////////////////////
TcMatSim_ModuleGeneratorInfo CTcComBoolCounterSafe::m_ModuleGeneratorInfo = {{23,2,0,2409890},{2,8,21,0}};


///////////////////////////////////////////////////////////////////////////////
// CTcComBoolCounterSafe implementation
///////////////////////////////////////////////////////////////////////////////
BEGIN_INTERFACE_MAP(CTcComBoolCounterSafe)
INTERFACE_ENTRY_ITCOMOBJECT()
	...
	INTERFACE_ENTRY(IID_ITcBoolCounterSafe,ITcBoolCounterSafe)
END_INTERFACE_MAP()

IMPLEMENT_ITCWATCHSOURCE(CTcComBoolCounterSafe)

BEGIN_OBJDATAAREA_MAP(CTcComBoolCounterSafe)
	OBJDATAAREA_SPAN_PTR_SIZE_LOCK(0, 1, &(Inports.maxOutputSize), sizeof(Inports.maxOutputSize), 0, VarAccess(Access::ReadWrite))
	OBJDATAAREA_SPAN_PTR_SIZE_LOCK(1, 1, &(Outports.count), sizeof(Outports.count), 0, VarAccess(Access::Read))
END_OBJDATAAREA_MAP()

BEGIN_SETOBJPARA_MAP2(CTcComBoolCounterSafe,TcMatSim::GeneratedTcCom)
...
BEGIN_GETOBJPARA_MAP2(CTcComBoolCounterSafe,TcMatSim::GeneratedTcCom)
...
BEGIN_OBJPARAWATCH_MAP2(CTcComBoolCounterSafe)
...
IMPLEMENT_ITCADI(CTcComBoolCounterSafe)

IMPLEMENT_IPERSIST_LIB(CTcComBoolCounterSafe,VID_Tc3_BoolCounter,CID_BOOLCOUNTERSAFE)

IMPLEMENT_GETMODULEINFO(CTcComBoolCounterSafe,BoolCounterSafe,CID_BOOLCOUNTERSAFE,VID_Tc3_BoolCounter)

BEGIN_OBJPARAASYNC_MAP2(CTcComBoolCounterSafe,TcMatSim::GeneratedTcCom)
	...
	OBJPARAASYNC_DATA_SPAN_PTR_SIZE_LOCK(0, 1, &(Inports.maxOutputSize), sizeof(Inports.maxOutputSize), 0, VarAccess(Access::ReadWrite))
	OBJPARAASYNC_DATA_SPAN_PTR_SIZE_LOCK(1, 1, &(Outports.count), sizeof(Outports.count), 0, VarAccess(Access::Read))
END_OBJPARAASYNC_MAP2(TcMatSim::GeneratedTcCom)

// State transition: Init -> PreOp
HRESULT CTcComBoolCounterSafe::SetObjStateIP(ITComObjectServer* ipSrv, TComInitDataHdr* pInitData)
{
	HRESULT hr = S_OK;
	...
	if (SUCCEEDED(hr))
	{
		memset(&(Inports.maxOutputSize),0,sizeof(Inports.maxOutputSize));
...
HRESULT CTcComBoolCounterSafe::SetObjStatePS(TComInitDataHdr* pInitData)
{
	HRESULT hr = S_OK;
...
HRESULT CTcComBoolCounterSafe::SetObjStateSO()
{
	HRESULT hr = S_OK;
...
HRESULT CTcComBoolCounterSafe::SetObjStateOS()
{
	HRESULT hr = S_OK;
...
HRESULT CTcComBoolCounterSafe::SetObjStateSP()
{
	HRESULT hr = S_OK;
...
HRESULT CTcComBoolCounterSafe::SetObjStatePI()
{
	HRESULT hr = S_OK;
...
// Constructor
CTcComBoolCounterSafe::CTcComBoolCounterSafe() :
...
HRESULT TCOMAPI CTcComBoolCounterSafe::CycleUpdate(ITcTask* ipTask, ITcUnknown* ipCaller, ULONG_PTR context)
{
...
HRESULT TCOMAPI CTcComBoolCounterSafe::PostCyclicUpdate(ITcTask* ipTask, ITcUnknown* ipCaller, ULONG_PTR context)
{
...
HRESULT CTcComBoolCounterSafe::Update(ITcTask* ipTask, ULONG_PTR context)
{
	...
	if(SUCCEEDED(hr) && m_ContextInfo[context].Synchronized)
	{
		...
		TcTry
		{
			if (hr == S_OK)
			{
				::count_and_invert_booleans_safe(boolArray,Inports.maxOutputSize,&Outports.count,inverseArray);
			}
...
HRESULT CTcComBoolCounterSafe::CheckAndAdaptCycleTimes()
{
	return S_OK;
...
// ITcBoolCounterSafe
HRESULT TCOMAPI CTcComBoolCounterSafe::count_and_invert_booleans_safe(double maxOutputSize, double* count)
{
	HRESULT hr = S_OK;
	auto fpCtrl = FpControl(FpCtrlSection::Update);

	::count_and_invert_booleans_safe(boolArray,maxOutputSize,count,inverseArray);
...
// ITcBoolCounterSafe
HRESULT TCOMAPI CTcComBoolCounterSafe::put_boolArray(bool* data, LONG size1, LONG size2)
{
	HRESULT hr(S_OK);
...
// ITcBoolCounterSafe
HRESULT TCOMAPI CTcComBoolCounterSafe::get_boolArray(bool* data, LONG& size1, LONG& size2)
{
	HRESULT hr(S_OK);
...
// ITcBoolCounterSafe
HRESULT TCOMAPI CTcComBoolCounterSafe::get_inverseArray(bool* data, LONG& size1, LONG& size2)
{
	HRESULT hr(S_OK);
...
HRESULT TCOMAPI Create_CTcComBoolCounterSafe (PITCID pIid, PPVOID pipItf)
{
	return Create<CTcComBoolCounterSafe>(*pIid, pipItf);
}
