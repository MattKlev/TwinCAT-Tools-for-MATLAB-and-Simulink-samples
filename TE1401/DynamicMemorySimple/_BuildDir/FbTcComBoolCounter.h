...
// *************************************************************
#ifndef _FbTcComBoolCounter__h_INCLUDED
#define _FbTcComBoolCounter__h_INCLUDED
...
public:
	...
	inline CLSID get_ClassID() {return CID_FB_BOOLCOUNTER_TCCOM_INITSTRUCT;}

	DECLARE_FUNC_MAP_FB()

	CFbTcComBoolCounter();
	~CFbTcComBoolCounter();
	bool FB_init(bool bInitRetains, bool bInCopyCode, ST_FB_BoolCounter_TcCOM_InitStruct& stInit);
	static void _FB_init(ST_FB_BoolCounter_TcCOM_InitStruct_FB_init* ST_Param);
	bool FB_afterinit();
	static void _FB_AfterInit(ST_FB_BoolCounter_TcCOM_InitStruct_FB_afterinit* ST_Param);
	bool Reinit(ST_FB_BoolCounter_TcCOM_InitStruct stReInit);
	static void _Reinit(ST_FB_BoolCounter_TcCOM_InitStruct_Reinit* ST_Param);
	bool FB_Main();
	static void _FB_Main(ST_FB_BoolCounter_TcCOM_InitStruct_FB_Main* ST_Param);
	bool FB_exit(bool bInCopyCode);
	static void _FB_exit(ST_FB_BoolCounter_TcCOM_InitStruct_FB_exit* ST_Param);
	...
	static void _put_boolArray(ST_FB_BoolCounter_TcCOM_InitStruct_put_boolArray* ST_Param);
	HRESULT get_boolArray(bool* data, LONG& size1, LONG& size2);
	static void _get_boolArray(ST_FB_BoolCounter_TcCOM_InitStruct_get_boolArray* ST_Param);
	...
	BoolCounter_Outports_T stOutports;
	ITcBoolCounter* _ipBoolCounter;
	ST_FB_BoolCounter_TcCOM_InitStruct stInit;


};
TYPESIZE_VALIDATION2(CFbTcComBoolCounter,528,552);

			
#endif // _FbTcComBoolCounter__h_INCLUDED
