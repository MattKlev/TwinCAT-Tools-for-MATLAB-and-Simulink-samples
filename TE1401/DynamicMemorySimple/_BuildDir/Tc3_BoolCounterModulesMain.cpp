...
class CTc3_BoolCounterCtrl  : public ITcOCFCtrlImpl< CTc3_BoolCounterCtrl, CTc3_BoolCounterClassFactory>
{
	public:
	CTc3_BoolCounterCtrl () {};
...
extern "C" __declspec(dllexport) HRESULT APIENTRY DllGetTcCtrl(ITcCtrl** ppTcCtrl)
{
	...
	if (ppTcCtrl != NULL)
	{
		ITcCtrl* pTcCtrl = new IUnknownImpl<CTc3_BoolCounterCtrl>;
		pTcCtrl->AddRef();
		*ppTcCtrl = pTcCtrl;
		hr = S_OK;
	}
